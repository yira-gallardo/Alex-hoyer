    ...
    <>
            ...
            <div className={styles.flex}>
              ...
              <div className={styles.right}>
                <div className={styles.socials}>
                  ...
                  <div className={styles.social}>
                    <a
                      href="https://www.instagram.com/alexhoyer/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
                  ...
                  <div className={styles.social}>
                    <a
                      href="https://x.com/hoyerofficial?s=09"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
      ...
      {isPopupOpen && (
        <div className={styles.popupVideo}>
          ...
          <div className={styles.popupVideoContainer}>
            <iframe
              width="560"
              height="315"
              src="https://www.youtube.com/embed/akOcZ3e454k?si=0kimH1Q7zOL0Bseg"
              title="YouTube video player"
              frameborder="0"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
              allowfullscreen
